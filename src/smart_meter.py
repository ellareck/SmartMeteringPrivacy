...
class SmartMeter:
    def __init__(self, pes_public_key, filename, num_reading_to_load = 60):
        ...
        self.encrypted_aes_key = self._encrypt_aes_key() # this is for pes
    ...
    def _encrypt_aes_key(self):
        # function that encrypts using RSA the smart meter AES key using the privacy system public key 
